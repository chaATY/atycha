  ...
  function (n, t, e) {
    ...
    function c(n, t) {
      for (var e = [], o = {}, i = 0; i < n.length; i++) {
        ...
        o[a] ? o[a].parts.push(c) : e.push((o[a] = { id: a, parts: [c] }));
      }
      return e;
    }
    function s(n, t) {
      for (var e = 0; e < n.length; e++) {
        ...
        if (r) {
          ...
          for (; a < o.parts.length; a++) r.parts.push(h(o.parts[a], t));
        } else {
          for (var c = []; a < o.parts.length; a++) c.push(h(o.parts[a], t));
          i[o.id] = { id: o.id, refs: 1, parts: c };
        }
      }
    }
    function l(n) {
  ...
  function (n, t, e) {
          ...
          n.forEach(function (n) {
            var t = (function (n, t) {
              if (n > 1 && n <= window.$docsify.toc.tocMaxLevel) {
                return ['<div class="lv' + n + '">', t, "</div>"].join("");
              }
              return "";
            })(n.tagName.replace(/h/gi, ""), n.innerHTML);
            t && o.push(t);
          }),
        o.length > 0 ? ((e = e.concat(o)).push("</div>"), e.join("")) : ""
      );
    }
    const i = () => {
      const n = window.innerHeight,
        t = document.querySelectorAll(`#main ${window.$docsify.toc.target}`);
      let e = [];
      t.forEach((t, o) => {
        const i = t.getBoundingClientRect();
        i.top <= n && i.height + i.top > 0 && e.push(o);
      });
      const o = document.scrollingElement || document.body;
      if (
        (0 === o.scrollTop
          ? (e = [0])
          : o.offsetHeight - window.innerHeight - o.scrollTop < 5 &&
            e.length > 0 &&
            (e = [e[e.length - 1]]),
        e.length)
      ) {
        document.querySelectorAll(".page_toc>div").forEach((n, t) => {
          t === e[0] ? n.classList.add("active") : n.classList.remove("active");
        });
      }
    };
    window.$docsify || (window.$docsify = {}),
      (window.$docsify.plugins = (window.$docsify.plugins || []).concat(
        function (n, t) {
          n.mounted(function () {
            var n = window.Docsify.dom.find(".content");
            if (n) {
              var t = window.Docsify.dom.create("aside", "");
              window.Docsify.dom.toggleClass(t, "add", "toc-nav"),
                window.Docsify.dom.before(n, t);
            }
          }),
            n.doneEach(function () {
              var n = window.Docsify.dom.find(".toc-nav");
              n &&
                ((n.innerHTML = o().trim()),
                "" === n.innerHTML
                  ? (window.Docsify.dom.toggleClass(n, "add", "nothing"),
                    window.document.removeEventListener("scroll", i))
                  : (window.Docsify.dom.toggleClass(n, "remove", "nothing"),
                    i(),
                    window.document.addEventListener("scroll", i)));
            });
        }
      ));
  },
