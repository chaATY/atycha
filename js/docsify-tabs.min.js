  ...
  function r() {
    var t = document.querySelector(".".concat(a.tabsContainer)),
      o = t
        ...
        : [],
      r = JSON.parse(sessionStorage.getItem(e.persist)) || {},
      i = JSON.parse(sessionStorage.getItem(e.sync)) || [];
    !(function () {
      var t = window.location.hash || window.location.search,
        o = decodeURIComponent((t.match(/(?:id=)([^&]+)/) || [])[1]),
        c = o && ".".concat(a.tabBlock, " #").concat(o);
      if (o && document.querySelector(c)) {
        var e,
          s = document.querySelector("#".concat(o));
        if (s.closest) e = s.closest(".".concat(a.tabContent));
        else
          for (
            e = s.parentNode;
            e !== document.body &&
            !e.classList.contains("".concat(a.tabContent));
      ...
      o.forEach(function (t, o) {
        var e = Array.apply(null, t.children).filter(function (t) {
        ...
        e ||
            ...
            (e = i
              .map(function (o) {
                return Array.apply(null, t.children).filter(function (t) {
                  return s(
                    t,
                    ".".concat(a.tabButton, '[data-tab="').concat(o, '"]')
                  );
                })[0];
              })
              .filter(function (t) {
          ...
          !e &&
            c.persist &&
            (e = Array.apply(null, t.children).filter(function (t) {
              return s(
                t,
                ".".concat(a.tabButton, '[data-tab="').concat(r[o], '"]')
              );
            })[0]),
          (e = e || t.querySelector(".".concat(a.tabButton))) &&
            e.classList.add(a.tabButtonActive));
      });
  }
  function n(t) {
    ...
    if (r) {
      ...
      if (
        ...
        r.classList.add(a.tabButtonActive),
        !o)
      ) {
        if (c.persist) {
          var u = (
            ...
            y = JSON.parse(sessionStorage.getItem(e.persist)) || {};
          (y[u] = i), sessionStorage.setItem(e.persist, JSON.stringify(y));
        }
        if (c.sync) {
          var p = d
              ? Array.apply(
              ...
              : [],
            m = JSON.parse(sessionStorage.getItem(e.sync)) || [];
          p.forEach(function (t) {
            ...
            0 !== m.indexOf(i) &&
              (m.unshift(i), sessionStorage.setItem(e.sync, JSON.stringify(m)));
        }
      }
    }
  }
  window &&
    ...
    Object.keys(window.$docsify.tabs).forEach(function (t) {
      Object.prototype.hasOwnProperty.call(c, t) &&
        (c[t] = window.$docsify.tabs[t]);
    }),
    (window.$docsify.tabs.version = "1.6.3"),
    (c.tabComments || c.tabHeadings) &&
      (window.$docsify.plugins = [].concat(
        ...
        function (e, s) {
          ...
          e.beforeEach(function (e) {
            return (
              (i = o.tabBlockMarkup.test(e)) &&
                (e = (function (e, s) {
                  for (
                    var r = e.match(o.codeMarkup) || [],
                      ...
                      i = c.theme
                        ? "".concat(a.tabBlock, "--").concat(c.theme)
                        : "",
                      d = document.createElement("div"),
                      b = e.match(o.tabBlockMarkup),
                      f = 1,
                      l = function () {
                        var r,
                          n = b[0],
                          ...
                          u = b[2],
                          y = b[4],
                          p = c.tabComments && o.tabCommentMarkup.test(n),
                          m = c.tabHeadings && o.tabHeadingMarkup.test(n),
                          h = "",
                          g = "";
                        if (p || m) {
                          (h = "\x3c!-- "
